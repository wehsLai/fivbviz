...
tf.col <- c(`Team Errors` = "teamFault", `Opp. Errors` = "opponentError", `Avg. by set` = "teamFaultAverageBySet", `Opp. Avg. by set` = "opponentErrorAverageBySet", y = "teamFaultOrgAverageBySet", x = "opponentErrorOrgAverageBySet")
